...
<!-- Data Tables -->
      ...
      "columns": [
          ...
          {"data": "id"},
          {
              "render": function(data, type, row) {
                  var btn = '<a href="<?php echo base_url('cliente/editar/'); ?>'+row.id+'">'+row.conta+'</a>';
                  return btn;
              },
  ...
  function excluirCliente(id)
  {
    ...
    $('#load').overlay();
    $.ajax({
        url: '<?php echo base_url('cliente/removeCliente'); ?>',
        type: 'POST',
        data:{
          id:id
        },
  ...
  function buscaCliente()
  {
    $.ajax({
        type:'POST',
        url:'<?php echo base_url('cliente/buscaListaCliente'); ?>',
        dataType: "json",
        success: function(data){
