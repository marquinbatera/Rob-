<?php
class Ci_vendedor_model extends CI_Model {
	...
	{
		$query = $this->db->query('SELECT v.id, v.nome, v.telefone, f.nome AS filial FROM vendedor AS v
					INNER JOIN filial AS f ON f.id = v.id_filial');
