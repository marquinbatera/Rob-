...
<div class="row margin-top-10 margin-bottom-20" >
      <div class="col-xs-6">
            <h3 class="title">Lista de Robôs</h3>
      </div>
      <div class="col-xs-6">
  ...
  <div class="row">
      <div class="col-md-12">
      		<div class="table-responsive">
                <table id="listRobo" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Nome</th>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Tem certeza que deseja excluir esse Robô?
      </div>
...
<!-- Data Tables -->
      ...
      "columns": [
          ...
          {"data": "id"},
          {
              "render": function(data, type, row) {
                  var btn = '<a href="<?php echo base_url('robo/editar/'); ?>'+row.id+'">'+row.nome+'</a>';
                  return btn;
              },
  ...
  function buscaRobo()
  {
    $.ajax({
        type:'POST',
        url:'<?php echo base_url('robo/buscaListaRobo'); ?>',
        dataType: "json",
        success: function(data){
