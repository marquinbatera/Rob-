    ...
    <div class="overlflow">
        <ul class="menu-list" id="menu-accordion" role="tablist" aria-multiselectable="true">
            ...
            <li class="panel">
                ...
                <ul id="menu-configuration" class="submenu">
                    <li><a href="<?php echo base_url('cliente/cadastro') ?>"><i class="glyphicon glyphicon-menu-right"></i>Cadastro</a></li>
                    <li><a href="<?php echo base_url('cliente/lista') ?>"><i class="glyphicon glyphicon-menu-right"></i>Lista de Clientes</a></li>
                </ul>
            </li>
            <li class="panel">
                <a href="">
                    <i class="icon icon-config"></i>Ativação de clientes
                </a>
                <ul id="menu-configuration" class="submenu">
                    <li><a href="<?php echo base_url('cliente/ativacao/cadastro') ?>"><i class="glyphicon glyphicon-menu-right"></i>Cadastro</a></li>
                    <li><a href="<?php echo base_url('cliente/ativacao/lista') ?>"><i class="glyphicon glyphicon-menu-right"></i>Lista de Ativos</a></li>
                </ul>
            </li>
            <?php if($this->ion_auth->is_admin()){ ?>
            <li class="panel">
                <a href="">
                    <i class="icon icon-config"></i>Usuários
                </a>
                <ul id="menu-configuration" class="submenu">
                    <li><a href="<?php echo base_url('usuario/cadastro') ?>"><i class="glyphicon glyphicon-menu-right"></i>Cadastro</a></li>
                    <li><a href="<?php echo base_url('usuario/lista') ?>"><i class="glyphicon glyphicon-menu-right"></i>Lista de Usuários</a></li>
                </ul>
            </li>
            <?php } ?>
            <li class="panel">
                <a href="">
                    <i class="icon icon-config"></i>Robôs
                </a>
                <ul id="menu-configuration" class="submenu">
                    <li><a href="<?php echo base_url('robo/cadastro') ?>"><i class="glyphicon glyphicon-menu-right"></i>Cadastro</a></li>
                    <li><a href="<?php echo base_url('robo/lista') ?>"><i class="glyphicon glyphicon-menu-right"></i>Lista de Robôs</a></li>
                </ul>
            </li>
            <li class="panel">
                <a href="">
                    <i class="icon icon-config"></i>Mensagens
                </a>
                <ul id="menu-configuration" class="submenu">
                    <li><a href="<?php echo base_url('robo/mensagem/cadastro') ?>"><i class="glyphicon glyphicon-menu-right"></i>Cadastro</a></li>
                    <li><a href="<?php echo base_url('robo/mensagem/lista') ?>"><i class="glyphicon glyphicon-menu-right"></i>Lista de Mensagens</a></li>
                </ul>
            </li>
            <li class="panel">
                <a href="<?php echo base_url('downloads') ?>">
                    <i class="icon icon-config"></i>Downloads
                </a>
                <!-- <ul id="menu-configuration" class="submenu">
       		...
       		<li>
            	<div class="btn-group">
                  ...
                  <div class="dropdown-menu dropdown-op dropdown-menu-right">
                    ...
                    <a href="<?php echo base_url('usuario/editar/').$this->session->userdata('id_user'); ?>" class="btn btn-primary pull-left">Editar</a>
