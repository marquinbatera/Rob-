...
class Vendedor extends CI_Controller {
	...
	public function newVendedor()
	{
		if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
			if ($this->input->post()) {
				...
				if ($user_id = $this->ci_vendedor_model->setUser($dados))
				{
			...
			$filiais = $this->ci_filial_model->getUserList();
			$data = array(
	...
	{
		if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
			$produtos = $this->ci_vendedor_model->getUserList();
			$data = array(
	...
	public function buscaListaVendedor() {
		if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
			$vendedor = $this->ci_vendedor_model->getListVendedor();
